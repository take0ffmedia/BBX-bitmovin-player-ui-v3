...
import { MetadataVideo, MetadataVideoContent } from './metadatavideo';
 ...
 */
export class TitleBarVideo extends Container<TitleBarConfig> {
    ...
    this.config = this.mergeConfig(
      config,
      {
        ...
        components: [
          ...
          new MetadataVideo({ content: MetadataVideoContent.Description }),
        ],
  ...
  configure(player: PlayerAPI, uimanager: UIInstanceManager): void {
    ...
    let checkMetadataTextAndUpdateVisibility = () => {
      ...
      for (let component of this.getComponents()) {
        if (component instanceof MetadataVideo) {
